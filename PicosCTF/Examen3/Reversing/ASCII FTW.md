...
1. Para resolver este reto, debemos desensamblar el codigo con ayuda de ghidra debido a que el archivo que nos dan es un ejecutable. 
2. Observando la función main, vemos lo siguiente:
```
...
```python()
3. Formamos una cadena con todos los valores exhadecimales:
70 69 63 6F 43 54 46 7B 41 53 43 49 49 5F 49 53 5F 45 41 53 59 5F 33 43 46 34 42 46 41 44 7D

4. Con ayuda de un decodificador, transformamos el exhadecimal a ASCCI, con lo cual obtenemos la bandera.
