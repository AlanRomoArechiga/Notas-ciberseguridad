...
```python()
1. Para resolver este reto, descargamos un archivo fun.pptm (diapositivas).
2. Al buscar e infagar por el archivo, no encontramos nada, pero hayamos una pista en el nombre del reto macro. Por lo que utlizaremos el comando binwalk -e. Lo que nos da los siguientes archivos:
└─$ ls
...
3. Al ver los archivos y sus nombres, nos llama la atencion el siguinete archivo, ya que dice "oculto" (ppt/slideMasters/hidden ) el cual contiene la bandera: ```
